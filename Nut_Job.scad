...
module hex_nut(nut_diameter,nut_height,nut_thread_step,nut_step_shape_degrees,nut_thread_outer_diameter,nut_resolution)
{

    difference()
    {
        hex_head(nut_height,nut_diameter);

        hex_countersink_ends(nut_thread_step/2,nut_thread_outer_diameter,nut_step_shape_degrees,nut_resolution,nut_height);

        screw_thread(nut_thread_outer_diameter,nut_thread_step,nut_step_shape_degrees,nut_height,nut_resolution,-2);
    }
}
